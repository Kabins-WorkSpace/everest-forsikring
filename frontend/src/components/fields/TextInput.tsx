...
export function TextInput({
  ...
  return (
    <div className={cn("w-full", className)}>
      <label
        htmlFor={id}
        className="mb-3 block font-medium text-2xl text-foreground leading-7"
      >
        {label}
      </label>
      ...
      <input
        ...
        className={cn(
          "h-12 w-full max-w-[28ch] border bg-white px-4 text-base text-foreground outline-none placeholder:text-neutral-rock",
          error
